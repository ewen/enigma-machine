...
enigma.rotor.create = function (type) {
  ...
  return {
    ...
    forwardRead: function (input) {
      ...
      // console.log('forward', input, adjustedInput, wiringInputLetter,
      //   wiringOutputLetter, adjustedOutput, output);
    ...
    reverseRead: function (input) {
      ...
      // console.log('reverse', input, adjustedInput, wiringInputLetter,
      //   wiringOutputLetter, adjustedOutput, output);
